  ...
  (exports.modules = {
    ...
    81605: (a, b, c) => {
      ...
      var d = c(21124),
        ...
        j = c(59405),
        k = c(15514)
      function l({ initialVolume: a = 1, className: b }) {
        let [c, l] = (0, e.useState)(a),
          [m, n] = (0, e.useState)({}),
          [o, p] = (0, e.useState)(new Set()),
          [q, r] = (0, e.useState)(null),
          [s, t] = (0, e.useState)([]),
          [u, v] = (0, e.useState)(!1),
          [w, x] = (0, e.useState)(!1),
          [y, z] = (0, e.useState)(null),
          A = Array.from({ length: 8 }, (a, b) => b + 1),
          B = [
            ...A.map((a) => ({ value: a, label: `Volume ${a}` })),
          ...
          C = async (a, b, d, e) => {
            ...
            try {
              let d = (
                'all' === c
                  ? (await Promise.all(A.map((a) => f.lH.getVolumeHadiths(a)))).flat()
                  : await f.lH.getVolumeHadiths(Number(c))
              ).filter((c) => c.category === a && c.chapter === b)
              t(d)
            } catch {
              t([])
            } finally {
          ...
          D = () => Object.values(m).reduce((a, b) => a + b.totalHadiths, 0)
        return (0, d.jsxs)('div', {
          className: (0, k.cn)('space-y-6', b),
          children: [
            (0, d.jsxs)('div', {
              ...
              children: [
                (0, d.jsxs)('div', {
                  ...
                  children: [
                    (0, d.jsx)(h.A, { className: 'h-8 w-8 text-foreground-muted' }),
                    (0, d.jsxs)('div', {
                      children: [
                        (0, d.jsx)('h3', {
                        ...
                        children: [
                          (0, d.jsx)('select', {
                            ...
                            onChange: (a) => {
                              ...
                              l('all' === b ? 'all' : isNaN(Number(b)) ? b : Number(b))
                            },
                            disabled: u,
                            className: (0, k.cn)(
                          ...
                          (0, d.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, d.jsxs)('span', {
                                ...
                                children: [D().toLocaleString(), ' hadiths'],
                              }),
                            ],
                          }),
                          (0, d.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, d.jsxs)('span', {
                                className: 'font-semibold text-foreground-muted',
                                children: [Object.keys(m).length, ' categories'],
                              }),
                            ],
                          }),
                          (0, d.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, d.jsx)('span', {
                                className: 'font-semibold text-foreground-muted',
                                children: 'all' === c ? 'All Volumes' : `Volume ${c}`,
                              }),
                            ],
                          }),
                        ],
                    ...
                    children: (0, d.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, d.jsx)('div', {
                          ...
                          children: Object.entries(m).map(([a, b]) =>
                            (0, d.jsxs)(
                              'div',
                              {
                                ...
                                children: [
                                  (0, d.jsxs)('button', {
                                    onClick: () =>
                                      ((a) => {
                                        let b = new Set(o)
                                        ;(b.has(a) ? b.delete(a) : b.add(a), p(b))
                                      })(a),
                                    className:
                    ...
                    children: q
                      ...
                      : (0, d.jsxs)('div', {
                          className:
                            'border-theme bg-card shadow-soft rounded-xl border p-12 text-center',
                          children: [
                            (0, d.jsx)(h.A, { className: 'text-muted mx-auto mb-4 h-12 w-12' }),
                            (0, d.jsx)('h4', {
