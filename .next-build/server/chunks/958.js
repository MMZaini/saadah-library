  ...
  (exports.modules = {
    ...
    19958: (a, b, c) => {
      ...
      var g = c(61365),
        h = c(15514),
        i = c(18085)
      function j({ bookId: a, bookName: b, volumes: c, baseRoute: j, className: k }) {
        let l = (0, f.useRouter)(),
          m = (0, g.c)(),
          [n, o] = (0, e.useState)(() => (c && 0 !== c.length ? c[0] : 'all')),
          [p, q] = (0, e.useState)({}),
          [r, s] = (0, e.useState)(new Set()),
          [t, u] = (0, e.useState)(!1),
          ...
          K = (b, d) => {
            let e
            if ((m.saveScrollPosition(window.scrollY), 'all' === n)) e = c && c.length ? c[0] : 1
            else {
              let a = String(n),
                b = a.match(/-Volume-(\d+)-/)
              e = b ? Number(b[1]) : isNaN(Number(a)) ? n : Number(a)
            }
            j &&
              (a.includes('Al_Kafi') || a.includes('Al-Kafi')
                ? l.push(`${j}/volume/${e}/chapter/${b}/${d}`)
                : l.push(`${j}/chapter/${b}/${d}`))
          },
          L = () => {
          ...
          N = () => Object.values(p).reduce((a, b) => a + b.totalHadiths, 0)
        return (0, d.jsxs)('div', {
          className: (0, h.cn)('space-y-6', k),
          children: [
            (0, d.jsxs)('div', {
                              ...
                              children: [
                                (0, d.jsx)('select', {
                                  ...
                                  onChange: (a) => {
                                    ...
                                    o('all' === b ? 'all' : isNaN(Number(b)) ? b : Number(b))
                                  },
                                  disabled: t,
                                  className: (0, h.cn)(
                          ...
                          (0, d.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, d.jsxs)('span', {
                                ...
                                children: [N().toLocaleString(), ' hadiths'],
                              }),
                            ],
                          }),
                          (0, d.jsxs)('div', {
            ...
            !t &&
              ...
              (0, d.jsx)('div', {
                className: 'space-y-6',
                children: Object.entries(p).map(([a, b]) =>
                  (0, d.jsxs)(
                    'div',
                    {
                      className:
                      ...
                      children: [
                        (0, d.jsxs)('button', {
                          onClick: () =>
                            ((a) => {
                              let b = new Set(r)
                              ;(b.has(a) ? b.delete(a) : b.add(a), s(b))
                            })(a),
                          className:
                          ...
                          children: [
                            (0, d.jsxs)('div', {
                              ...
                              children: [
                                (0, d.jsx)('div', {
                                  className: `transition-transform duration-200 ${r.has(a) ? 'rotate-90' : 'rotate-0'}`,
                              ...
                              children: Object.entries(b.chapters).map(([a, c]) => {
                                ...
                                return (0, d.jsxs)(
                                  'button',
                                  {
                                    onClick: (a) => {
                                      if (B.current) {
                                        ;(a.preventDefault(), a.stopPropagation(), (B.current = !1))
                                        return
                                      }
                                      K(b.categoryId, c.chapterInCategoryId)
                                    },
                                    ...((g = () => K(b.categoryId, c.chapterInCategoryId)),
                                    {
                                      onTouchStart: (a) => {
                                        let b = a.touches && a.touches[0]
                                        ;(b && (C.current = { x: b.clientX, y: b.clientY }),
                                          (D.current = Date.now()),
                                          (E.current = !1),
                                          L(),
                                      ...
                                      onTouchMove: (a) => {
                                        ...
                                        ;(d > 20 || e > 20) && (B.current = !0)
                                      },
                                      onTouchEnd: (a) => {
                                        let b = D.current || Date.now(),
                                          c = Date.now() - b
                                        if (
                                          (L(),
                                          (C.current = null),
      ...
      function k({ bookId: a, bookName: b, volumes: c, baseRoute: e, className: f }) {
        return (0, d.jsx)(j, {
          bookId: a,
          bookName: b || a,
          volumes: c,
