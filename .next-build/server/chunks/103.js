...
For more information, see https://radix-ui.com/primitives/docs/components/${b.docsSlug}`
                          ...
                          async fn(b) {
                            ...
                            if (
                              ...
                              if (
                                ...
                                return { data: { index: a, overflows: P }, reset: { placement: b } }
                              let c =
                                null ==
    ...
    26053: (a, b, c) => {
      ...
      var d = c(38301),
        ...
        q = d.forwardRef((a, b) => {
          let {
            ...
            y = (0, f.s)(b, (a) => x(a)),
            z = d.useRef(!1),
            A = !w || s || !!w.closest('form'),
            [B, C] = (0, h.i)({ prop: i, defaultProp: m ?? !1, onChange: r, caller: l })
          return (0, k.jsxs)(o, {
            scope: c,
            checked: B,
            disabled: p,
            children: [
              (0, k.jsx)(j.sG.button, {
                ...
                ...v,
                ref: y,
                onClick: (0, e.mK)(a.onClick, (a) => {
                  ;(C((a) => !a),
                    A && ((z.current = a.isPropagationStopped()), z.current || a.stopPropagation()))
                }),
              }),
              A &&
                (0, k.jsx)(t, {
      ...
      var r = 'SwitchThumb',
        s = d.forwardRef((a, b) => {
          let { __scopeSwitch: c, ...d } = a,
            e = p(r, c)
          return (0, k.jsx)(j.sG.span, {
            'data-state': u(e.checked),
      ...
      s.displayName = r
      var t = d.forwardRef(
        ({ __scopeSwitch: a, control: b, checked: c, bubbles: e = !0, ...g }, h) => {
          let j = d.useRef(null),
            l = (0, f.s)(j, h),
            m = (function (a) {
          ...
          return (
            d.useEffect(() => {
              ...
              if (m !== c && b) {
                let d = new Event('click', { bubbles: e })
      ...
      t.displayName = 'SwitchBubbleInput'
      var v = q,
        w = s
    },
    26453: (a, b, c) => {
    ...
    33043: (a, b, c) => {
      ...
      let d = c(60894)
      function e(a) {
        return (0, d.pathHasPrefix)(a, '/read')
      }
      ;('function' == typeof b.default || ('object' == typeof b.default && null !== b.default)) &&
        void 0 === b.default.__esModule &&
        (Object.defineProperty(b.default, '__esModule', { value: !0 }),
    ...
    35103: (a, b, c) => {
      ...
      let d = '/read'
      function e(a) {
        return (0 === d.length || (a = a.slice(d.length)).startsWith('/') || (a = '/' + a), a)
      }
      ;('function' == typeof b.default || ('object' == typeof b.default && null !== b.default)) &&
        void 0 === b.default.__esModule &&
        (Object.defineProperty(b.default, '__esModule', { value: !0 }),
...
Read more: https://nextjs.org/docs/app/api-reference/functions/generate-viewport`)
    ...
    70121: (a, b, c) => {
      'use strict'
      c.d(b, { UC: () => W, ZL: () => V, Kq: () => S, bL: () => T, l9: () => U })
      var d = c(38301),
        e = c(87868),
        f = c(92808),
        g = c(2332),
        ...
        r = d.forwardRef((a, b) =>
          (0, n.jsx)(m.sG.span, { ...a, ref: b, style: { ...q, ...a.style } }),
        )
      r.displayName = 'VisuallyHidden'
      var [s, t] = (0, g.A)('Tooltip', [j.Bk]),
        u = (0, j.Bk)(),
        v = 'TooltipProvider',
        w = 'tooltip.open',
        [x, y] = s(v),
      ...
      var A = 'Tooltip',
        ...
        D = (a) => {
          let {
            ...
            l = y(A, a.__scopeTooltip),
            m = u(b),
            [o, q] = d.useState(null),
            r = (0, i.B)(),
            s = d.useRef(0),
            t = h ?? l.disableHoverableContent,
            v = k ?? l.delayDuration,
            x = d.useRef(!1),
            [z, C] = (0, p.i)({
              prop: e,
              defaultProp: f ?? !1,
              onChange: (a) => {
                ;(a ? (l.onOpen(), document.dispatchEvent(new CustomEvent(w))) : l.onClose(),
                  g?.(a))
              },
              caller: A,
            }),
            D = d.useMemo(
              () => (z ? (x.current ? 'delayed-open' : 'instant-open') : 'closed'),
              [z],
            ),
            E = d.useCallback(() => {
              ;(window.clearTimeout(s.current), (s.current = 0), (x.current = !1), C(!0))
            }, [C]),
            F = d.useCallback(() => {
              ;(window.clearTimeout(s.current), (s.current = 0), C(!1))
            }, [C]),
            G = d.useCallback(() => {
              ;(window.clearTimeout(s.current),
                (s.current = window.setTimeout(() => {
                  ;((x.current = !0), C(!0), (s.current = 0))
                }, v)))
            }, [v, C])
          return (
            d.useEffect(
            ...
            (0, n.jsx)(j.bL, {
              ...
              children: (0, n.jsx)(B, {
                ...
                onTriggerLeave: d.useCallback(() => {
                  t ? F() : (window.clearTimeout(s.current), (s.current = 0))
                }, [F, t]),
                onOpen: E,
                onClose: F,
      ...
      var E = 'TooltipTrigger',
        F = d.forwardRef((a, b) => {
          let { __scopeTooltip: c, ...g } = a,
            ...
            k = u(c),
            l = d.useRef(null),
            o = (0, f.s)(b, l, h.onTriggerChange),
            p = d.useRef(!1),
            q = d.useRef(!1),
            r = d.useCallback(() => (p.current = !1), [])
          return (
            d.useEffect(() => () => document.removeEventListener('pointerup', r), [r]),
            (0, n.jsx)(j.Mz, {
              asChild: !0,
              ...k,
              children: (0, n.jsx)(m.sG.button, {
                ...
                ...g,
                ref: o,
                onPointerMove: (0, e.mK)(a.onPointerMove, (a) => {
                  'touch' !== a.pointerType &&
                    (q.current ||
                      i.isPointerInTransitRef.current ||
                      (h.onTriggerEnter(), (q.current = !0)))
                }),
                onPointerLeave: (0, e.mK)(a.onPointerLeave, () => {
                  ;(h.onTriggerLeave(), (q.current = !1))
                }),
                onPointerDown: (0, e.mK)(a.onPointerDown, () => {
                  ;(h.open && h.onClose(),
                    (p.current = !0),
                    document.addEventListener('pointerup', r, { once: !0 }))
                }),
                onFocus: (0, e.mK)(a.onFocus, () => {
                  p.current || h.onOpen()
                }),
                onBlur: (0, e.mK)(a.onBlur, h.onClose),
                onClick: (0, e.mK)(a.onClick, h.onClose),
              }),
            })
          )
        })
      F.displayName = E
      var G = 'TooltipPortal',
        [H, I] = s(G, { forceMount: void 0 }),
        J = (a) => {
          let { __scopeTooltip: b, forceMount: c, children: d, container: e } = a,
            f = C(G, b)
          return (0, n.jsx)(H, {
            scope: b,
            forceMount: c,
            children: (0, n.jsx)(l.C, {
              present: c || f.open,
              children: (0, n.jsx)(k.Z, { asChild: !0, container: e, children: d }),
            }),
          })
        }
      J.displayName = G
      var K = 'TooltipContent',
        L = d.forwardRef((a, b) => {
          let c = I(K, a.__scopeTooltip),
            { forceMount: d = c.forceMount, side: e = 'top', ...f } = a,
            g = C(K, a.__scopeTooltip)
          return (0, n.jsx)(l.C, {
            present: d || g.open,
            children: g.disableHoverableContent
              ? (0, n.jsx)(Q, { side: e, ...f, ref: b })
              : (0, n.jsx)(M, { side: e, ...f, ref: b }),
          })
        }),
        M = d.forwardRef((a, b) => {
          let c = C(K, a.__scopeTooltip),
            e = y(K, a.__scopeTooltip),
            g = d.useRef(null),
            h = (0, f.s)(b, g),
            [i, j] = d.useState(null),
            { trigger: k, onClose: l } = c,
            m = g.current,
            { onPointerInTransitChange: o } = e,
            p = d.useCallback(() => {
              ;(j(null), o(!1))
            }, [o]),
            q = d.useCallback(
        ...
        [N, O] = s(A, { isInside: !1 }),
        P = (function (a) {
          let b = ({ children: a }) => (0, n.jsx)(n.Fragment, { children: a })
          return ((b.displayName = `${a}.Slottable`), (b.__radixId = o), b)
        })('TooltipContent'),
        Q = d.forwardRef((a, b) => {
          let {
              __scopeTooltip: c,
          ...
          return (
            d.useEffect(
              () => (document.addEventListener(w, o), () => document.removeEventListener(w, o)),
              [o],
            ),
            d.useEffect(() => {
              if (l.trigger) {
              ...
              children: (0, n.jsxs)(j.UC, {
                ...
                children: [
                  ...
                  (0, n.jsx)(N, {
                    scope: c,
                    isInside: !0,
                    children: (0, n.jsx)(r, { id: l.contentId, role: 'tooltip', children: f || e }),
                  }),
                ],
              }),
            })
      ...
      d.forwardRef((a, b) => {
        let { __scopeTooltip: c, ...d } = a,
          e = u(c)
        return O(R, c).isInside ? null : (0, n.jsx)(j.i3, { ...e, ...d, ref: b })
      }).displayName = R
      var S = z,
        T = D,
        U = F,
        ...
        Object.defineProperty(b, 'applyRouterStatePatchToTree', {
          ...
          get: function () {
            return function a(b, c, d, i) {
              ...
              else if (null === (j = a((0, e.getNextFlightSegmentPath)(b), l[q], d, i))) return null
              let r = [b[0], { ...l, [q]: j }, m, n]
    ...
    83973: (a, b, c) => {
      ...
      var e = c(96425),
        ...
        j = d.forwardRef((a, b) => {
          var c
          let { decorative: d, orientation: e = h, ...j } = a,
            k = ((c = e), i.includes(c)) ? e : h
...
${b}`,
    ...
    92464: (a, b, c) => {
      ...
      let d = c(42511),
        e = c(11107)
      function f(a, b) {
        return (0, e.normalizePathTrailingSlash)((0, d.addPathPrefix)(a, '/read'))
      }
      ;('function' == typeof b.default || ('object' == typeof b.default && null !== b.default)) &&
        void 0 === b.default.__esModule &&
        (Object.defineProperty(b.default, '__esModule', { value: !0 }),
                ...
                (a.tuple = function (a) {
                  ...
                  return new h({
                    ...
                    *entries(c) {
                    ...
                    validator: (a) =>
                      Array.isArray(a) || `Expected an array, but received: ${e(a)}`,
                  })
                }),
                (a.type = s),
                (a.union = function (a) {
