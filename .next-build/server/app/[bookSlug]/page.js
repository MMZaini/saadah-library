;(() => {
  ...
  ;((a.id = 341),
    ...
    (a.modules = {
      ...
      9641: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 13075))
      },
      10846: (a) => {
        'use strict'
      ...
      13075: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Admin\\\\Desktop\\\\sl\\\\saadah-library\\\\app\\\\[bookSlug]\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
      ...
      16265: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 53721))
      },
      19121: (a) => {
        'use strict'
      ...
      53721: (a, b, c) => {
        ...
        function v() {
          let a = (0, f.useParams)(),
            ...
            A = (0, g.bE)(z),
            B = (0, e.useRef)(null),
            { history: C, addToHistory: D, clearHistory: E } = (0, k.d)(B),
            [F, G] = (0, e.useState)(!1),
            [H, I] = (0, e.useState)({ bookInfo: null, hadiths: [], loading: !0, error: null }),
            [J, K] = (0, e.useState)(''),
            [L, M] = (0, e.useState)([]),
            [N, O] = (0, e.useState)(!1),
            [P, Q] = (0, e.useState)(null),
            [R, S] = (0, e.useState)('structure'),
            T = (0, e.useMemo)(() => {
              let a = (0, g.ei)(A)
              return a?.hasMultipleVolumes && a.volumes && a.volumes.length > 0 ? a.volumes : [A]
            }, [A]),
            U = (0, e.useMemo)(
              () =>
                (0, l.sg)(async (a) => {
                  ...
                  try {
                    let b = await fetch(
                        `/read/api/search?q=${encodeURIComponent(a)}&book=${T.join(',')}`,
                      ),
                      c = await b.json()
                    ...
                    ;(M([]), Q('Search failed. Please try again.'), x(null))
                  } finally {
                    O(!1)
                  }
                }, 300),
                ...
                children: (0, d.jsxs)('div', {
                  ...
                  children: [
                    (0, d.jsx)('p', {
                      ...
                      children: H.error || 'Book not found',
                    }),
                    (0, d.jsx)(o.$, {
                      variant: 'outline',
                      onClick: () => b.push('/'),
          ...
          return (0, d.jsxs)('main', {
            ...
            children: [
                  ...
                  children: [
                    (0, d.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, d.jsx)('input', {
                          ref: B,
                          placeholder: `Search across all ${Z} volumes… (Ctrl+K)`,
                          value: J,
                          ...
                          onKeyDown: (a) => {
                            ;('Enter' === a.key && (J.trim() && D(J.trim()), G(!1)),
                              'Escape' === a.key && (G(!1), B.current?.blur()))
                          },
                          className:
                          ...
                          (0, d.jsxs)('div', {
                            ...
                            children: [
                              (0, d.jsxs)(n.E, {
                                variant: 'secondary',
                                children: [
                                  X?.volumeCount ?? (X?.volumes?.length || 1),
                                  ' ',
                                  (X?.volumeCount ?? 1) > 1 ? 'Volumes' : 'Volume',
                                ],
                              }),
                              (0, d.jsx)(n.E, { variant: 'secondary', children: Z }),
                            ],
                          }),
                        ],
                      }),
              ...
              (0, d.jsx)(i.A, {
                ...
                onSearch: V,
                onClearSearch: () => {
                  ;(U.cancel(), K(''), M([]), Q(null), x(null), G(!1))
                },
                searchContext: A,
                searchError: P,
              }),
                    ...
                    (0, d.jsx)(e.Suspense, {
                      ...
                      children:
                        'structure' === R
                          ? (0, d.jsx)(u, {
                              bookId: W.bookId,
                              bookName: W.englishName,
                              volumes: X?.volumes ?? [W.bookId],
                              baseRoute: `/${z}`,
                            })
                          : 'chapters' === R
                            ? (0, d.jsx)(s, { bookId: A, bookConfig: X })
                            : (0, d.jsx)(t, {
                                bookConfig: X || {
                                  bookId: W.bookId,
      ...
      63976: (a, b, c) => {
        ...
        let H = {
          ...
          I = ['C:\\Users\\Admin\\Desktop\\sl\\saadah-library\\app\\[bookSlug]\\page.tsx'],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a)
  var c = b.X(0, [331, 103, 298, 576, 963, 818, 951], () => b((b.s = 63976)))
  module.exports = c
})()
