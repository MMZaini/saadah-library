    ...
    (a.modules = {
      ...
      16110: (a, b, c) => {
        ...
        let H = {
                        ...
                        children: [
                          '[hadithId]',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(c.bind(c, 40406)),
          ...
          K = new d.AppPageRouteModule({
            definition: {
              ...
              page: '/[bookSlug]/hadith/[hadithId]/page',
              pathname: '/[bookSlug]/hadith/[hadithId]',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
        ...
        async function L(a, b, d) {
          var C
          let G = '/[bookSlug]/hadith/[hadithId]/page'
          '/index' === G && (G = '/')
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      22488: (a, b, c) => {
        ...
        function m() {
          let a = (0, f.useRouter)(),
            b = (0, f.useParams)(),
            { setChapterInfo: c } = (0, i.h)(),
            m = b?.bookSlug,
            n = (0, g.bE)(m)
          parseInt(b.hadithId)
          let [o, p] = (0, e.useState)(null),
            [q, r] = (0, e.useState)(!0),
            [s, t] = (0, e.useState)(null),
            u = () => {
              o?.volume &&
              o?.categoryId &&
              o?.chapterInCategoryId !== null &&
              o?.chapterInCategoryId !== void 0
                ? a.push(`/${m}/chapter/${o.categoryId}/${o.chapterInCategoryId}`)
                : a.push(`/${m}`)
            },
            v = (0, g.ei)(n || '')?.englishName || m?.replace(/-/g, ' ') || 'Book'
          return q
            ? (0, d.jsx)('main', {
                  ...
                  children: (0, d.jsxs)('div', {
                    ...
                    children: [
                      (0, d.jsxs)('button', {
                        ...
                        children: [(0, d.jsx)(l.A, { className: 'h-3.5 w-3.5' }), 'Back to ', v],
                      }),
                      (0, d.jsx)('div', {
                    ...
                    children: [
                      ...
                      (0, d.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, d.jsx)('div', {
                            className: 'ml-6',
                            children: (0, d.jsx)(h.A, { hadith: o, showViewChapter: !1 }),
                          }),
                        ],
                      }),
                    ],
      ...
      40406: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Admin\\\\Desktop\\\\sl\\\\saadah-library\\\\app\\\\[bookSlug]\\\\hadith\\\\[hadithId]\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
          'C:\\Users\\Admin\\Desktop\\sl\\saadah-library\\app\\[bookSlug]\\hadith\\[hadithId]\\page.tsx',
          'default',
      ...
      42258: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 22488))
      },
      63033: (a) => {
        'use strict'
  ...
  b.C(a)
  var c = b.X(0, [331, 103, 298, 576, 963, 818], () => b((b.s = 16110)))
  module.exports = c
})()
