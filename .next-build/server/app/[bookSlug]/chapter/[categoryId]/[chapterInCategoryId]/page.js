    ...
    (a.modules = {
      ...
      7291: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Admin\\\\Desktop\\\\sl\\\\saadah-library\\\\app\\\\[bookSlug]\\\\chapter\\\\[categoryId]\\\\[chapterInCategoryId]\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
      ...
      31666: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 7291))
      },
      33873: (a) => {
        'use strict'
      ...
      59868: (a, b, c) => {
        ...
        let H = {
          ...
          K = new d.AppPageRouteModule({
            definition: {
              ...
              page: '/[bookSlug]/chapter/[categoryId]/[chapterInCategoryId]/page',
              pathname: '/[bookSlug]/chapter/[categoryId]/[chapterInCategoryId]',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
        ...
        async function L(a, b, d) {
          var C
          let G = '/[bookSlug]/chapter/[categoryId]/[chapterInCategoryId]/page'
          '/index' === G && (G = '/')
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      78522: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 99101))
      },
      86439: (a) => {
        'use strict'
      ...
      99101: (a, b, c) => {
        ...
        function n() {
          let a = (0, f.useRouter)(),
            ...
            n = b.bookSlug
          ;((0, g.bE)(n), b.categoryId, parseInt(b.chapterInCategoryId))
          let [o, p] = (0, e.useState)([]),
            [q, r] = (0, e.useState)(!0),
          ...
          return q
            ? (0, d.jsx)('main', {
                ...
                children: (0, d.jsxs)('div', {
                  ...
                  children: [
                    (0, d.jsx)(l.A, { className: 'h-6 w-6 animate-spin text-foreground-muted' }),
                    (0, d.jsx)('span', {
                    ...
                    children: [
                        ...
                        (0, d.jsxs)('div', {
                          ...
                          children: [
                            ...
                            (0, d.jsxs)('p', {
                              ...
                              children: ['Category: ', u.category],
                            }),
                            (0, d.jsx)('div', {
                              className: 'mt-2 flex gap-1.5',
                              children: (0, d.jsxs)(k.E, {
                                variant: 'secondary',
                                children: [u.hadithCount, ' Hadiths'],
                              }),
                            }),
                          ],
                        }),
                      ...
                      (0, d.jsx)('div', {
                        ...
                        children: (0, d.jsxs)(j.$, {
                          variant: 'outline',
                          onClick: () => a.push('/'),
                          children: [(0, d.jsx)(m.A, { className: 'mr-1.5 h-3.5 w-3.5' }), 'Back'],
                        }),
                      }),
                    ],
                  }),
  ...
  b.C(a)
  var c = b.X(0, [331, 103, 298, 576, 963, 818], () => b((b.s = 59868)))
  module.exports = c
})()
