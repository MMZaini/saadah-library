...
;(() => {
      ...
      55331: (a, b, c) => {
        ...
        async function w() {
          try {
            return (
              await (0, v.Er)(),
              u.NextResponse.json({ ok: !0, message: 'Arabic index is ready or being built' })
            )
          } catch {
            return u.NextResponse.json(
              { ok: !1, error: 'Failed to ensure Arabic index' },
              { status: 500 },
            )
          }
        }
        let x = new e.AppRouteRouteModule({
            definition: {
              ...
              page: '/api/admin/arabic-index-status/route',
              pathname: '/api/admin/arabic-index-status',
              filename: 'route',
              bundlePath: 'app/api/admin/arabic-index-status/route',
            },
            distDir: '.next-build',
            relativeProjectDir: '',
            resolvedPagePath:
              'C:\\Users\\Admin\\Desktop\\sl\\saadah-library\\app\\api\\admin\\arabic-index-status\\route.ts',
            nextConfigOutput: '',
            userland: d,
          }),
        ...
        async function C(a, b, c) {
          var d
          let e = '/api/admin/arabic-index-status/route'
          '/index' === e && (e = '/')
  ...
  b.C(a)
  var c = b.X(0, [331, 692, 999], () => b((b.s = 55331)))
  module.exports = c
})()
