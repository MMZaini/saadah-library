...
;(() => {
    ...
    (a.modules = {
      ...
      77569: (a, b, c) => {
        ...
        async function w() {
          try {
            return (
              ...
              u.NextResponse.json({
                ok: !0,
                message: 'Arabic index rebuild triggered and completed',
              })
            )
          } catch {
            return u.NextResponse.json({ ok: !1, error: 'Rebuild failed' }, { status: 500 })
          }
        }
        let x = new e.AppRouteRouteModule({
            definition: {
              kind: f.RouteKind.APP_ROUTE,
              page: '/api/admin/rebuild-arabic-index/route',
              pathname: '/api/admin/rebuild-arabic-index',
              filename: 'route',
              bundlePath: 'app/api/admin/rebuild-arabic-index/route',
            },
            distDir: '.next-build',
            relativeProjectDir: '',
            resolvedPagePath:
              'C:\\Users\\Admin\\Desktop\\sl\\saadah-library\\app\\api\\admin\\rebuild-arabic-index\\route.ts',
            nextConfigOutput: '',
            userland: d,
          }),
        ...
        async function C(a, b, c) {
          var d
          let e = '/api/admin/rebuild-arabic-index/route'
          '/index' === e && (e = '/')
  ...
  b.C(a)
  var c = b.X(0, [331, 692, 999], () => b((b.s = 77569)))
  module.exports = c
})()
