;(() => {
  ...
  ;((a.id = 370),
    ...
    (a.modules = {
      ...
      6220: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 49898))
      },
      10846: (a) => {
        'use strict'
      ...
      49898: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Admin\\\\Desktop\\\\sl\\\\saadah-library\\\\app\\\\uyun-akhbar-al-rida\\\\hadith\\\\[hadithId]\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
      ...
      62200: (a, b, c) => {
        ...
        function l() {
          ...
          parseInt(b.hadithId)
          let [l, m] = (0, e.useState)(null),
            [n, o] = (0, e.useState)(!0),
            [p, q] = (0, e.useState)(null),
            r = () => {
              l?.volume &&
              l?.categoryId &&
              l?.chapterInCategoryId !== null &&
              l?.chapterInCategoryId !== void 0
                ? a.push(
                    `/Uyun-akhbar-al-Rida/volume/${l.volume}/chapter/${l.categoryId}/${l.chapterInCategoryId}`,
                  )
                : a.push('/Uyun-akhbar-al-Rida')
            }
          return n
            ? (0, d.jsx)('main', {
                      ...
                      (0, d.jsx)('div', {
                        ...
                        children: (0, d.jsxs)('div', {
                          ...
                          children: [
                            ...
                            (0, d.jsx)(i.$, {
                              onClick: r,
                              children: 'Return to ʿUyūn akhbār al-Riḍā',
                            }),
                          ],
                        }),
                      }),
                    ...
                    children: [
                      ...
                      (0, d.jsxs)('div', {
                        ...
                        children: [
                          (0, d.jsxs)('h1', {
                            ...
                            children: ['ʿUyūn akhbār al-Riḍā Hadith #', l.id],
                          }),
                          (0, d.jsxs)('p', {
                      ...
                      (0, d.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, d.jsx)('div', {
                            className: 'ml-6',
                            children: (0, d.jsx)(g.A, { hadith: l, showViewChapter: !1 }),
                          }),
                        ],
                      }),
                    ],
      ...
      67494: (a, b, c) => {
        ...
        let H = {
          ...
          K = new d.AppPageRouteModule({
            definition: {
              ...
              page: '/uyun-akhbar-al-rida/hadith/[hadithId]/page',
              pathname: '/uyun-akhbar-al-rida/hadith/[hadithId]',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
        ...
        async function L(a, b, d) {
          var C
          let G = '/uyun-akhbar-al-rida/hadith/[hadithId]/page'
          '/index' === G && (G = '/')
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      93068: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 62200))
      },
    }))
  var b = require('../../../../webpack-runtime.js')
  b.C(a)
  var c = b.X(0, [331, 103, 298, 576, 963, 818], () => b((b.s = 67494)))
  module.exports = c
})()
