    ...
    (a.modules = {
      ...
      13053: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Admin\\\\Desktop\\\\sl\\\\saadah-library\\\\app\\\\al-kafi\\\\hadith\\\\[hadithId]\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
          ...
          let [l, m] = (0, e.useState)(null),
            ...
            r = () => {
              ...
              l?.chapterInCategoryId !== void 0
                ? a.push(
                    `/al-kafi/volume/${l.volume}/chapter/${l.categoryId}/${l.chapterInCategoryId}`,
                  )
                : a.push('/al-kafi')
            }
          return n
                      ...
                      (0, d.jsx)('div', {
                        ...
                        children: (0, d.jsxs)('div', {
                          ...
                          children: [
                            ...
                            (0, d.jsx)(i.$, { onClick: r, children: 'Return to Al-Kāfi' }),
                          ],
                        }),
                      }),
                    ],
      ...
      36456: (a, b, c) => {
        ...
        let H = {
                        ...
                        children: [
                          '[hadithId]',
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(c.bind(c, 13053)),
                                  'C:\\Users\\Admin\\Desktop\\sl\\saadah-library\\app\\al-kafi\\hadith\\[hadithId]\\page.tsx',
                                ],
                              },
                            ],
          ...
          K = new d.AppPageRouteModule({
            definition: {
              ...
              page: '/al-kafi/hadith/[hadithId]/page',
              pathname: '/al-kafi/hadith/[hadithId]',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
        ...
        async function L(a, b, d) {
          var C
          let G = '/al-kafi/hadith/[hadithId]/page'
          '/index' === G && (G = '/')
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      57413: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 21047))
      },
      63033: (a) => {
        'use strict'
  ...
  b.C(a)
  var c = b.X(0, [331, 103, 298, 576, 963, 818], () => b((b.s = 36456)))
  module.exports = c
})()
