    ...
    (a.modules = {
      ...
      12017: (a, b, c) => {
        ...
        var g = c(21096),
          ...
          q = c(88285),
          r = c(15303)
        let s = (0, e.lazy)(() => c.e(602).then(c.bind(c, 47602))),
          t = (0, e.lazy)(() => c.e(696).then(c.bind(c, 696))),
          u = (0, e.lazy)(() => c.e(958).then(c.bind(c, 19958)))
        function v() {
          let a = (0, f.useParams)(),
            b = (0, f.useRouter)(),
            {
            ...
            z = a?.bookId,
            A = (0, e.useRef)(null),
            { history: B, addToHistory: C, clearHistory: D } = (0, k.d)(A),
            [E, F] = (0, e.useState)(!1),
            [G, H] = (0, e.useState)({ bookInfo: null, hadiths: [], loading: !0, error: null }),
            [I, J] = (0, e.useState)(''),
            [K, L] = (0, e.useState)([]),
            [M, N] = (0, e.useState)(!1),
            [O, P] = (0, e.useState)(null),
            [Q, R] = (0, e.useState)('structure'),
            S = (0, e.useMemo)(() => {
              let a = (0, g.ei)(z)
              return a?.hasMultipleVolumes && a.volumes && a.volumes.length > 0 ? a.volumes : [z]
            }, [z]),
            T = (0, e.useMemo)(
              () =>
                (0, l.sg)(async (a) => {
                  ...
                  try {
                    let b = await fetch(
                        `/read/api/search?q=${encodeURIComponent(a)}&book=${S.join(',')}`,
                      ),
                      c = await b.json()
                    if (!b.ok || c.error) throw Error(c.error || 'Search failed')
                    let d = c.results
                    ;(L(d),
                      x({
                        query: a,
                    ...
                    ;(L([]), P('Search failed. Please try again.'), x(null))
                  } finally {
                    N(!1)
                  }
                }, 300),
                ...
                children: (0, d.jsxs)('div', {
                  ...
                  children: [
                    (0, d.jsx)('p', {
                      ...
                      children: G.error || 'Book not found',
                    }),
                    (0, d.jsx)(o.$, {
                      variant: 'outline',
                      onClick: () => b.push('/'),
          ...
          let { bookInfo: V } = G,
            ...
            Z =
              ...
              ((a) => {
                ...
                for (let a of h.b) {
                  let c = X(a.title)
                  if (c && (b.includes(c) || c.includes(b))) return a.image
                }
                return null
              })(z)
          return (0, d.jsxs)('main', {
            ...
            children: [
                ...
                children: (0, d.jsxs)('div', {
                  ...
                  children: [
                    (0, d.jsxs)('div', {
                      ...
                      children: [
                        (0, d.jsx)(q.A, { className: 'h-4 w-4 shrink-0 text-foreground-faint' }),
                        (0, d.jsx)('input', {
                          ref: A,
                          placeholder: `Search across all ${Y} volumes… (Ctrl+K)`,
                          value: I,
                          ...
                          onKeyDown: (a) => {
                            ;('Enter' === a.key && (I.trim() && C(I.trim()), F(!1)),
                              'Escape' === a.key && (F(!1), A.current?.blur()))
                          },
                          className:
                          ...
                          (0, d.jsxs)('div', {
                            ...
                            children: [
                              (0, d.jsxs)(n.E, {
                                variant: 'secondary',
                                children: [
                                  W?.volumeCount ?? (W?.volumes?.length || 1),
                                  ' ',
                                  (W?.volumeCount ?? 1) > 1 ? 'Volumes' : 'Volume',
                                ],
                              }),
                              (0, d.jsx)(n.E, { variant: 'secondary', children: Y }),
                              ((W && 'Man-La-Yahduruh-al-Faqih' === W.bookId) ||
                                V?.bookId?.startsWith('Man-La-Yahduruh-al-Faqih')) &&
                                (0, d.jsx)(n.E, {
                                  variant: 'secondary',
                                  children: 'One of the Four Major Books',
                                }),
                            ],
                          }),
                        ],
              ...
              (0, d.jsx)(i.A, {
                ...
                onSearch: U,
                onClearSearch: () => {
                  ;(T.cancel(), J(''), L([]), P(null), x(null), F(!1))
                },
                searchContext: z,
                searchError: O,
              }),
                    ...
                    (0, d.jsx)(e.Suspense, {
                      ...
                      children:
                        'structure' === Q
                          ? (0, d.jsx)(u, {
                              bookId: V.bookId,
                              bookName: V.englishName,
                              volumes: W?.volumes ?? [V.bookId],
                              baseRoute: `/book/${V.bookId}`,
                            })
                          : 'chapters' === Q
                            ? (0, d.jsx)(s, { bookId: z, bookConfig: W })
                            : (0, d.jsx)(t, {
                                bookConfig: W || {
                                  bookId: V.bookId,
      ...
      36530: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 68915))
      },
      41025: (a) => {
        'use strict'
      ...
      68915: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Admin\\\\Desktop\\\\sl\\\\saadah-library\\\\app\\\\book\\\\[bookId]\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      99738: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 12017))
      },
    }))
  var b = require('../../../webpack-runtime.js')
  b.C(a)
  var c = b.X(0, [331, 103, 298, 576, 963, 818, 951], () => b((b.s = 84264)))
  module.exports = c
})()
