;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    1057: (a, e, t) => {
      Promise.resolve().then(t.bind(t, 5553))
    },
    5553: (a, e, t) => {
      'use strict'
      ...
      var l = t(5155),
        ...
        r = t(5239)
      function n(a) {
        let { quality: e = 75, alt: t, ...s } = a
        return (0, l.jsx)(r.default, { ...s, alt: t, quality: e, unoptimized: !0 })
      }
      var u = t(2619),
        d = t.n(u),
        o = t(2740)
      ...
      function m(a) {
        let { book: e } = a,
          t = e.bookId || h[e.id],
          s = 1 === e.id ? '/al-kafi' : t ? '/'.concat((0, o.yU)(t)) : '#',
          i = (0, l.jsxs)('div', {
            className:
        ...
        return '#' !== s ? (0, l.jsx)(d(), { href: s, className: 'block', children: i }) : i
      }
      var c = t(1995),
        g = t(3243),
        p = t(2355),
      ...
      function j() {
        let {
            ...
            getSearchState: t,
            saveSearchState: r,
            saveScrollPosition: n,
          } = (0, g.c)(),
          u = (0, s.useRef)(null),
          { history: d, addToHistory: o, clearHistory: h } = (0, p.d)(u),
          [j, q] = (0, s.useState)(!1),
          [w, A] = (0, s.useState)(''),
          [S, k] = (0, s.useState)([]),
          [v, N] = (0, s.useState)(!1),
        ...
        ;((0, s.useEffect)(() => {
          let l = a()
          ;(l > 0 && requestAnimationFrame(() => window.scrollTo(0, l)), e('/'))
          let s = t()
          s && (A(s.query), k(s.results))
        }, [a, e, t]),
          (0, s.useEffect)(() => {
            let a = () => {
              ;(A(''), k([]), r(null))
            ...
            return (
              window.addEventListener('clearSearch', a),
              () => window.removeEventListener('clearSearch', a)
            )
          }, [r]),
          (0, s.useEffect)(() => {
            let a = () => n(window.scrollY)
            return (
              window.addEventListener('beforeunload', a),
              () => {
                ;(window.removeEventListener('beforeunload', a), n(window.scrollY))
              }
            )
          }, [n]))
        let E = (0, s.useMemo)(
          () =>
            (0, b.sg)(async (a) => {
              ...
              try {
                let e = await fetch(
                  ''.concat('/read', '/api/search?q=').concat(encodeURIComponent(a)),
                )
                if (!e.ok) throw Error('Search request failed')
                let t = await e.json()
                ...
                ;(k([]), K('Search failed. Please try again.'), r(null))
              } finally {
                N(!1)
              }
            }, 300),
        ...
        return (0, l.jsxs)('div', {
          ...
          children: [
              ...
              children: (0, l.jsxs)('div', {
                ...
                children: [
                  (0, l.jsxs)('div', {
                    ...
                    children: [
                      (0, l.jsx)(x.A, { className: 'h-4 w-4 shrink-0 text-foreground-faint' }),
                      (0, l.jsx)('input', {
                        ref: u,
                        ...
                        onBlur: () => setTimeout(() => q(!1), 200),
                        onKeyDown: (a) => {
                          if (
                            ('Enter' === a.key && (w.trim() && o(w.trim()), q(!1)),
                            'Escape' === a.key)
                          ) {
                            var e
                            ;(q(!1), null == (e = u.current) || e.blur())
                          }
                        },
                        className:
                          ...
                          (0, l.jsxs)(
                            'button',
                            {
                              ...
                              children: [
                                ...
                                (0, l.jsx)('span', { className: 'truncate', children: a }),
                              ],
                            },
                            e,
                          ),
            ...
            (0, l.jsx)(c.A, {
              ...
              onSearch: E,
              onClearSearch: () => {
                ;(E.cancel(), A(''), k([]), K(null), r(null), q(!1))
              },
              ...
              (0, l.jsxs)('section', {
                ...
                children: [
                  ...
                  (0, l.jsx)('div', {
                    ...
                    children: i.b.map((a) => (0, l.jsx)(m, { book: a }, a.id)),
                  }),
                ],
              }),
          ],
  ...
  (a) => {
    ;(a.O(0, [307, 346, 619, 84, 952, 579, 962, 665, 441, 255, 358], () => a((a.s = 1057))),
      (_N_E = a.O()))
  },
])
