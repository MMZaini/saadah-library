;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [722],
  {
      ...
      function m() {
        ...
        return ((0, a.useEffect)(() => {
          let e = async () => {
            ;(N(!0), y(null))
            try {
              let e = (await d.A1.getBookHadiths(m)).filter(
              ...
              y('Failed to load chapter content')
            } finally {
              N(!1)
            }
          }
          return (m && x && !isNaN(p) && e(), () => s(null))
        }, [m, x, p, s]),
        j)
          ? (0, r.jsx)('main', {
                  ...
                  children: [
                    ...
                    (0, r.jsx)('div', {
                      ...
                      children: (0, r.jsxs)(i.$, {
                        variant: 'outline',
                        onClick: () => e.push('/'),
                        children: [(0, r.jsx)(h.A, { className: 'mr-1.5 h-3.5 w-3.5' }), 'Back'],
                      }),
                    }),
                  ],
                }),
    ...
    8063: (e, t, s) => {
      Promise.resolve().then(s.bind(s, 717))
    },
  },
  (e) => {
    ;(e.O(0, [307, 346, 952, 579, 962, 441, 255, 358], () => e((e.s = 8063))), (_N_E = e.O()))
  },
])
