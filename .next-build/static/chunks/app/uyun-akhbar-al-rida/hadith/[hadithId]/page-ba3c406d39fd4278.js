;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [370],
  {
      ...
      function h() {
        ...
        ;((0, r.useEffect)(() => {
          let e = async () => {
            ;(p(!0), y(null))
            try {
              let e = await o.C$.findHadithAcrossBooks(
                ['Uyun-akhbar-al-Rida-Volume-1-Saduq', 'Uyun-akhbar-al-Rida-Volume-2-Saduq'],
                h,
              )
              if (!e) return void y('Hadith not found')
              ;(x(e),
                a({
                  volumeId: e.volume,
        ...
        let j = () => {
          ...
          (null == m ? void 0 : m.chapterInCategoryId) !== void 0
            ? e.push(
                '/Uyun-akhbar-al-Rida/volume/'
                  .concat(m.volume, '/chapter/')
                  .concat(m.categoryId, '/')
                  .concat(m.chapterInCategoryId),
              )
            : e.push('/Uyun-akhbar-al-Rida')
        }
        return f
          ? (0, s.jsx)('main', {
                ...
                children: (0, s.jsxs)('div', {
                  ...
                  children: [
                    (0, s.jsxs)('button', {
                      ...
                      children: [
                        (0, s.jsx)(i.A, { className: 'h-3.5 w-3.5' }),
                ...
                children: (0, s.jsxs)('div', {
                  ...
                  children: [
                    (0, s.jsxs)('button', {
                      ...
                      className:
                        'mb-6 flex items-center gap-1.5 text-sm text-foreground-muted transition-colors hover:text-foreground',
                      children: [(0, s.jsx)(i.A, { className: 'h-3.5 w-3.5' }), 'Back to Chapter'],
                    }),
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        (0, s.jsxs)('h1', {
                          ...
                          children: ['ʿUyūn akhbār al-Riḍā Hadith #', m.id],
                        }),
                        (0, s.jsxs)('p', {
                    ...
                    (0, s.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, s.jsx)('div', {
                          className: 'ml-6',
                          children: (0, s.jsx)(l.A, { hadith: m, showViewChapter: !1 }),
                        }),
                      ],
                    }),
                  ],
    ...
    3668: (e, t, a) => {
      ...
      function o(e) {
        ...
        return (0, s.jsx)(n.Provider, { value: { chapterInfo: a, setChapterInfo: o }, children: t })
      }
      function l() {
    ...
    4020: (e, t, a) => {
      Promise.resolve().then(a.bind(a, 3178))
    },
    5626: (e, t, a) => {
      'use strict'
      a.d(t, { A: () => s })
      let s = (0, a(5121).A)('arrow-left', [
  ...
  (e) => {
    ;(e.O(0, [307, 346, 952, 579, 962, 441, 255, 358], () => e((e.s = 4020))), (_N_E = e.O()))
  },
])
