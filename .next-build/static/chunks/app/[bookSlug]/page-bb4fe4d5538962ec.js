;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [341],
  {
    ...
    368: (e, a, t) => {
      'use strict'
      t.d(a, { A: () => l })
      let l = (0, t(5121).A)('chevron-left', [['path', { d: 'm15 18-6-6 6-6', key: '1wnfg3' }]])
    },
    4521: (e, a, t) => {
      'use strict'
      ...
      var l = t(5155),
        ...
        b = t(6651),
        f = t(6983)
      let y = (0, s.lazy)(() => t.e(658).then(t.bind(t, 4658))),
        k = (0, s.lazy)(() => t.e(426).then(t.bind(t, 3426))),
        j = (0, s.lazy)(() => t.e(571).then(t.bind(t, 952)))
      function v() {
        var e, a, t, v, N
        let A = (0, n.useParams)(),
          w = (0, n.useRouter)(),
          ...
          R = null == A ? void 0 : A.bookSlug,
          I = (0, o.bE)(R),
          z = (0, s.useRef)(null),
          { history: K, addToHistory: D, clearHistory: P } = (0, m.d)(z),
          [B, F] = (0, s.useState)(!1),
          [T, _] = (0, s.useState)({ bookInfo: null, hadiths: [], loading: !0, error: null }),
          [L, V] = (0, s.useState)(''),
          [G, Y] = (0, s.useState)([]),
          [H, Z] = (0, s.useState)(!1),
          [O, Q] = (0, s.useState)(null),
          [U, $] = (0, s.useState)('structure'),
          J = (0, s.useMemo)(() => {
            let e = (0, o.ei)(I)
            return (null == e ? void 0 : e.hasMultipleVolumes) && e.volumes && e.volumes.length > 0
              ? e.volumes
              : [I]
          }, [I])
        ;((0, s.useEffect)(() => {
          let e = M()
          ;(e > 0 && requestAnimationFrame(() => window.scrollTo(0, e)), q('/'.concat(R)))
          let a = S()
          a && (V(a.query), Y(a.results))
        }, [M, q, S, R]),
          (0, s.useEffect)(() => {
            let e = () => E(window.scrollY)
            return (
              window.addEventListener('beforeunload', e),
              () => {
                ;(window.removeEventListener('beforeunload', e), E(window.scrollY))
              }
            )
          }, [E]))
        let W = (0, s.useMemo)(
              ...
              (0, h.sg)(async (e) => {
                ...
                try {
                  let a = await fetch(
                    ...
                    t = await a.json()
                  if (!a.ok || t.error) throw Error(t.error || 'Search failed')
                  let l = t.results
                  ;(Y(l),
                    C({
                      query: e,
                  ...
                  ;(Y([]), Q('Search failed. Please try again.'), C(null))
                } finally {
                  Z(!1)
                }
              }, 300),
        ...
        if (
          ((0, s.useEffect)(() => {
            ;(async () => {
              if (I) {
                _((e) => ({ ...e, loading: !0, error: null }))
                try {
                  let l = (await r.C$.getAllBooks()).find((e) => e.bookId === I)
                  if (!l) {
                    let s = (0, o.ei)(I)
                    if (s) {
                      var e, a, t
                      let n = (e) =>
                          (e || '')
                            ...
                            .replace(/[^a-z0-9]+/g, ''),
                        r = n(s.englishName || s.bookId),
                        o = i.b.find((e) => {
                          let a = n(e.title)
                          return a && (a.includes(r) || r.includes(a))
                        })
                      l = {
                        bookId: s.bookId,
                        BookName: (null == o ? void 0 : o.title) || s.englishName,
                        author: (null == o ? void 0 : o.author) || '',
                        idRangeMin: 0,
                        idRangeMax: 0,
                        bookDescription: (null == o ? void 0 : o.description) || '',
                        bookCover: (null == o ? void 0 : o.image) || '',
                        englishName: s.englishName,
                        translator: '',
                        volume:
                          null !=
                          (t =
                            null != (a = s.volumeCount)
                              ? a
                              : null == (e = s.volumes)
                                ? void 0
                                : e.length)
                  ...
                  if (!l) return void _((e) => ({ ...e, error: 'Book not found', loading: !1 }))
                  _((e) => ({ ...e, bookInfo: l, loading: !1 }))
                } catch (e) {
                  _((e) => ({ ...e, error: 'Failed to load book data', loading: !1 }))
                }
              }
            })()
          }, [I]),
          ...
          return (0, l.jsx)('main', {
            ...
            children: (0, l.jsx)('div', {
              ...
              children: (0, l.jsx)(x.A, {
                className: 'h-8 w-8 animate-spin text-foreground-muted',
              }),
            }),
          })
        if (T.error || !T.bookInfo)
          return (0, l.jsx)('main', {
            className: 'min-h-screen',
            children: (0, l.jsx)('div', {
              className: 'flex min-h-[60vh] items-center justify-center',
              children: (0, l.jsxs)('div', {
                ...
                children: [
                  (0, l.jsx)('p', {
                    ...
                    children: T.error || 'Book not found',
                  }),
                  (0, l.jsx)(p.$, {
                    variant: 'outline',
                    onClick: () => w.push('/'),
                    children: 'Go back to library',
                  }),
                ],
              }),
            }),
        ...
        let { bookInfo: ee } = T,
          ...
          el =
            ...
            (null == (e = (0, o.ei)(I)) ? void 0 : e.englishName) ||
            (null == ee ? void 0 : ee.englishName) ||
            (null == ee ? void 0 : ee.BookName) ||
            I,
          es =
            (null == ee ? void 0 : ee.bookCover) ||
            ((e) => {
              if (!e) return null
              let a = et(e)
              for (let e of i.b) {
                let t = et(e.title)
                if (t && (a.includes(t) || t.includes(a))) return e.image
              }
              return null
            })(I)
        return (0, l.jsxs)('main', {
          ...
          children: [
              ...
              children: (0, l.jsxs)('div', {
                ...
                children: [
                  (0, l.jsxs)('div', {
                    ...
                    children: [
                      (0, l.jsx)(b.A, { className: 'h-4 w-4 shrink-0 text-foreground-faint' }),
                      (0, l.jsx)('input', {
                        ref: z,
                        placeholder: 'Search across all '.concat(el, ' volumes… (Ctrl+K)'),
                        value: L,
                        ...
                        onKeyDown: (e) => {
                          if (
                            ('Enter' === e.key && (L.trim() && D(L.trim()), F(!1)),
                            'Escape' === e.key)
                          ) {
                            var a
                            ;(F(!1), null == (a = z.current) || a.blur())
                          }
                        },
                        className:
                          ...
                          (0, l.jsxs)(
                            'button',
                            {
                              ...
                              children: [
                                ...
                                (0, l.jsx)('span', { className: 'truncate', children: e }),
                              ],
                            },
                            a,
                          ),
                ...
                children: (0, l.jsxs)('div', {
                  ...
                  children: [
                    es &&
                      (0, l.jsx)('img', {
                        src: es,
                        alt: (null == ee ? void 0 : ee.englishName) || el,
                    ...
                    (0, l.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (null == ee ? void 0 : ee.author) &&
                          (0, l.jsx)('p', {
                            className: 'mt-1 text-sm text-foreground-muted',
                            children: ee.author,
                          }),
                        (null == ee ? void 0 : ee.bookDescription) &&
                          (0, l.jsx)('p', {
                            className: 'mt-3 text-sm leading-relaxed text-foreground-muted',
                            children: ee.bookDescription,
                          }),
                        (0, l.jsxs)('div', {
                          ...
                          children: [
                            (0, l.jsxs)(g.E, {
                              variant: 'secondary',
                              children: [
                                null != (t = null == ea ? void 0 : ea.volumeCount)
                                  ? t
                                  : (null == ea || null == (a = ea.volumes) ? void 0 : a.length) ||
                                    1,
                                ' ',
                                (null != (v = null == ea ? void 0 : ea.volumeCount) ? v : 1) > 1
                                  ? 'Volumes'
                                  : 'Volume',
                              ],
                            }),
                            (0, l.jsx)(g.E, { variant: 'secondary', children: el }),
                          ],
                        }),
                      ],
                    }),
            ...
            (0, l.jsx)(u.A, {
              ...
              onSearch: X,
              onClearSearch: () => {
                ;(W.cancel(), V(''), Y([]), Q(null), C(null), F(!1))
              },
              searchContext: I,
              searchError: O,
            }),
                        ...
                        children: [
                          ...
                          (0, l.jsxs)(
                            'button',
                            {
                              ...
                              children: [
                                (0, l.jsx)('span', { className: 'sm:hidden', children: e.short }),
                                (0, l.jsx)('span', {
                  ...
                  (0, l.jsx)(s.Suspense, {
                    ...
                    children:
                      'structure' === U
                        ? (0, l.jsx)(j, {
                            bookId: ee.bookId,
                            bookName: ee.englishName,
                            volumes:
                              null != (N = null == ea ? void 0 : ea.volumes) ? N : [ee.bookId],
                            baseRoute: '/'.concat(R),
                          })
                        : 'chapters' === U
                          ? (0, l.jsx)(y, { bookId: I, bookConfig: ea })
                          : (0, l.jsx)(k, {
                              bookConfig: ea || {
                                bookId: ee.bookId,
                                englishName: ee.englishName,
                                baseName: ee.bookId,
                                volumes: [ee.bookId],
    ...
    6630: (e, a, t) => {
      'use strict'
      t.d(a, { A: () => l })
      let l = (0, t(5121).A)('sliders-horizontal', [
    ...
    6651: (e, a, t) => {
      'use strict'
      t.d(a, { A: () => l })
      let l = (0, t(5121).A)('search', [
        ['path', { d: 'm21 21-4.34-4.34', key: '14j7rj' }],
        ['circle', { cx: '11', cy: '11', r: '8', key: '4ej97u' }],
      ])
    },
    6711: (e, a, t) => {
      Promise.resolve().then(t.bind(t, 4521))
    },
    6983: (e, a, t) => {
      'use strict'
      t.d(a, { A: () => l })
      let l = (0, t(5121).A)('clock', [
        ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
  ...
  (e) => {
    ;(e.O(0, [307, 346, 952, 579, 962, 665, 441, 255, 358], () => e((e.s = 6711))), (_N_E = e.O()))
  },
])
