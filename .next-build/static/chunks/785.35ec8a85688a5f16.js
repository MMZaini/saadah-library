    ...
    3166: (e, l, r) => {
      ...
      function n(e) {
        let { className: l } = e,
          ...
          f = [
            ...Array.from({ length: 8 }, (e, l) => l + 1).map((e) => ({
              value: e,
              label: 'Volume '.concat(e),
            })),
          ...
          b = async (e) => {
            ...
            try {
              let l
              if ('all' === e) {
                let e = Math.floor(8 * Math.random()) + 1
                l = await a.lH.getRandomHadithFromVolume(e)
              } else l = await a.lH.getRandomHadithFromVolume(e)
              c(l)
            } catch (e) {
              x('Failed to load hadith from this volume')
            } finally {
              u(!1)
            }
          }
                            ...
                            children: [
                              (0, s.jsx)('select', {
                                ...
                                onChange: (e) => {
                                  var l
                                  ;(n(
                                    (l = 'all' === e.target.value ? 'all' : Number(e.target.value)),
                                  ),
                                    b(l))
                                },
                                disabled: m,
                    ...
                    children: [
                      ...
                      (0, s.jsxs)('span', {
                        ...
                        children: [
                          'Loading hadith from',
                          ' ',
                          'all' === r ? 'All Al-Kāfi Volumes' : 'Volume '.concat(r),
                          '...',
                        ],
                      }),
                    ],
                      ...
                      children: [
                        ...
                        (0, s.jsxs)('span', {
                          children: [
                            'Random hadith from',
                            ' ',
                            'all' === r ? 'All Al-Kāfi Volumes' : 'Al-Kāfi Volume '.concat(r),
                          ],
                        }),
                      ],
                    }),
                    (0, s.jsx)(o.A, { hadith: i }),
                  ],
                }),
            ],
          })
